...
if __name__ == "__main__":
    sys.path.insert(0, str(Path(__file__).parent.parent))  # add src/cableviz to PATH
...
from cableviz.DataClasses import Metadata, Options, Tweak
from cableviz.Harness import Harness
...
def main():
    print("When running from the command line, please use cv_cli.py instead.")
