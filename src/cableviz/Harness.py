...
from cableviz import APP_NAME, APP_URL, __version__, cv_colors
from cableviz.cv_bom import (
    HEADER_MPN,
    HEADER_PN,
    HEADER_SPN,
    bom_list,
...
from cableviz.cv_colors import get_color_hex, translate_color
from cableviz.cv_gv_html import (
    html_bgcolor,
    html_bgcolor_attr,
    html_caption,
    html_colorbar,
...
from cableviz.cv_helper import (
    awg_equiv,
    file_write_text,
    mm2_equiv,
    tuplelist2tsv,
)
from cableviz.cv_html import generate_html_output
from cableviz.DataClasses import (
    Cable,
    Connector,
    MateComponent,
    MatePin,
...
from cableviz.svgembed import embed_svg_images, embed_svg_images_file
...
class Harness:
    ...
    def create_graph(self) -> Graph:
        ...
        dot.attr(
            ...
            rankdir="LR",
            ranksep="2",
            bgcolor=cv_colors.translate_color(self.options.bgcolor, "HEX"),
            nodesep="0.33",
        ...
        dot.attr(
            ...
            style="filled",
            fillcolor=cv_colors.translate_color(self.options.bgcolor_node, "HEX"),
            fontname=self.options.fontname,
        )
        ...
        for cable in self.cables.values():
            ...
            for i, (connection_color, wirelabel) in enumerate(
                ...
                colorstr = cv_colors.translate_color(
                ...
                for j, bgcolor in enumerate(bgcolors[::-1]):  # Reverse to match the curved wires when more than 2 colors
                    wirehtml.append(f'      <tr><td colspan="3" cellpadding="0" height="2" bgcolor="{bgcolor if bgcolor != "" else cv_colors.default_color}" border="0"></td></tr>')
            ...
            if cable.shield:
                ...
                if isinstance(cable.shield, str):
                    ...
                    shield_color_hex = cv_colors.get_color_hex(cable.shield)[0]
                    attributes = (
