...
import cableviz.cableviz as cv
from cableviz import APP_NAME, __version__
from cableviz.cv_helper import file_read_text
...
def cableviz(file, format, prepend, output_dir, output_name, version):
    """
    Parses the provided FILE and generates the specified outputs.
    """
    print(r"""
           _     _            _     
  ___ __ _| |__ | | _____   _(_)____
 / __/ _` | '_ \| |/ _ \ \ / / |_  /
| (_| (_| | |_) | |  __/\ V /| |/ / 
