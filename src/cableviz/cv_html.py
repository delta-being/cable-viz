...
from cableviz.cv_gv_html import html_line_breaks
...
from cableviz.DataClasses import Metadata, Options
from cableviz.svgembed import data_URI_base64
...
def generate_html_output(
    ...
    replacements = {
        ...
        "<!-- %bgcolor% -->": cv_colors.translate_color(options.bgcolor, "hex"),
