...
from cableviz.cv_colors import translate_color
from cableviz.cv_gv_html import html_bgcolor_attr, html_line_breaks
from cableviz.cv_helper import clean_whitespace
from cableviz.DataClasses import AdditionalComponent, Cable, Color, Connector
...
def generate_bom(harness: "Harness") -> List[BOMEntry]:
    ...
    from cableviz.Harness import Harness  # Local import to avoid circular imports
